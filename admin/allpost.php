...
while ($d = mysqli_fetch_array($data)) {
    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit.php?id=<?php echo $d['id']; ?>"><img
                                                            src="../assets/img/pencil-3x.png" class="img-fluid"></a>
                                                    <a href="hapus.php?id=<?php echo $d['id']; ?>"><img
                                                            src="../assets/img/trash-3x.png" class="img-fluid"></a>
                                                </td>
                                            </tr>
                                            <?php
}
